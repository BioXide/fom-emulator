...
|---|---|---|---|---|
| 0x00 | msgId | u8 | raw | 0x78 |
| 0x01 | worldId | u8 | compressed bits | Written from SharedMem index 0 (world id gate). |
| 0x.. | playerId | u32 | compressed | SharedMem[0x5B] (playerId). |
| 0x.. | slot6 | u32 | compressed | SharedMem slot 6 (written by `SendWorldDataCheck`). |
