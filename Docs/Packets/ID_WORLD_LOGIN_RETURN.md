...
|---|---|---|---|---|
| 0x00 | msgId | u8 | raw | 0x73 |
| 0x01 | code | u8 | compressed | Login return status (1 = success) |
| 0x.. | flag | u8 | compressed | Typically 0xFF in ctor |
| 0x.. | worldIp | u32 | compressed | Encode 127.0.0.1 as 0x7F000001 |
| 0x.. | worldPort | u16 | compressed | |
